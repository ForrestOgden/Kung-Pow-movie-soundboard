  ...
  assignAudioClip('owl', `What do you get when you cross an owl with a bungee cord?`);
  ...
  assignAudioClip('wrongtraining', `We have purposely trained him wrong, as a joke.`);
  ...
  assignAudioClip('waterfall', `He spends his time at the top of a waterfall...`);
  assignAudioClip('mynuts', `I am a great magician. Your clothes are red!`);
  assignAudioClip('honor', `Master Pain, it is a great honor having you beating random people in our town.`);
  ...
  assignAudioClip('options', `So here were my options`);
  assignAudioClip('ab', `Two options: A or B`);
  assignAudioClip('a', `Hmm... Should have gone with A`);
  assignAudioClip('anotherparalyzer', `Another paralyzer!`);
  assignAudioClip('lesson', `At that moment, the Chosen One learned a valuable lesson about iron claws...`);
  assignAudioClip('upover', `Big deal. Up and over!`);
  assignAudioClip('wary', `Be wary of Betty's iron claws`);
  assignAudioClip('spoil', `Don't spoil everything. This works for both of us...`);
  assignAudioClip('spoil2', `The director said cut... You should stop that now...`);
  ...
  assignAudioClip('crap', `Didn't recognize you without the crap in your pants`);
  ...
  assignAudioClip('signal3', `He did sasy he was gonna throw us off his body...`);
